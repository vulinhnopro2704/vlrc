  ...
  return (
    <div className="rounded-xl bg-gradient-to-br from-primary/10 to-primary/5 p-6 dark:from-primary/20 dark:to-primary/10 dark:backdrop-blur-sm">
      <div className="mb-4 flex items-center justify-between">
        ...
        <span className="rounded-full bg-primary/20 px-2 py-1 text-xs font-medium text-primary">{t('due')}</span>
      </div>
      ...
      <div className="flex justify-center gap-2">
        <span className="rounded-lg bg-destructive/10 px-3 py-1 text-xs text-destructive">{t('forgot')}</span>
        <span className="rounded-lg bg-yellow-500/10 px-3 py-1 text-xs text-yellow-600 dark:text-yellow-400">{t('hard')}</span>
        <span className="rounded-lg bg-primary/10 px-3 py-1 text-xs text-primary">{t('good')}</span>
        <span className="rounded-lg bg-green-500/10 px-3 py-1 text-xs text-green-600 dark:text-green-400">{t('easy')}</span>
      </div>
    </div>
  );
};
  ...
  return (
    <div className="rounded-xl bg-gradient-to-br from-green-500/10 to-green-500/5 p-6 dark:from-green-500/20 dark:to-green-500/10 dark:backdrop-blur-sm">
      ...
      <div className="space-y-3">
        ...
        <ProgressBar label={t('listening')} value="8/10" percent={80} color="bg-primary" />
        <ProgressBar label={t('writing')} value="3/5" percent={60} color="bg-accent" />
      </div>
    </div>
  );
};
