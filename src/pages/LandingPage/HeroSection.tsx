    ...
    <section
      ...
      <div className='container mx-auto px-4'>
        <div className='mx-auto max-w-4xl text-center'>
          ...
          <p className='mt-6 text-sm text-muted-foreground'>{t('no_credit_card')}</p>
        </div>
  ...
  return (
    <div className='rounded-xl bg-gradient-to-br from-primary/10 to-primary/5 p-6 dark:from-primary/20 dark:to-primary/10 dark:backdrop-blur-sm'>
      ...
      <div className='flex justify-center gap-2'>
        <span className='rounded-lg bg-destructive/10 px-3 py-1 text-xs text-destructive'>
          {t('forgot')}
        </span>
        <span className='rounded-lg bg-yellow-500/10 px-3 py-1 text-xs text-yellow-600 dark:text-yellow-400'>
          {t('hard')}
        </span>
        <span className='rounded-lg bg-primary/10 px-3 py-1 text-xs text-primary'>{t('good')}</span>
        <span className='rounded-lg bg-green-500/10 px-3 py-1 text-xs text-green-600 dark:text-green-400'>
          {t('easy')}
        </span>
      </div>
    </div>
