...
export const ExperienceSection = () => {
  ...
  const tabIcons = { listening: Icons.Headphones, reading: Icons.BookOpen, writing: Icons.PenTool };
    ...
    <section ref={sectionRef} className='bg-secondary/30 py-20 lg:py-28 dark:bg-secondary/10'>
      <div className='container mx-auto px-4'>
        <div className='mx-auto mb-16 max-w-3xl text-center'>
          ...
          <p className='text-lg text-muted-foreground'>{t('experience_subtitle')}</p>
        </div>
        ...
        <div className='mx-auto max-w-4xl'>
          ...
          <Card
            ref={cardRef}
            className='border-0 shadow-xl dark:bg-card/60 dark:backdrop-blur-md dark:border dark:border-white/10'>
...
const TabContent = ({ tab }: { tab: TabType }) => {
  ...
  return (
    <div className='grid items-center gap-8 md:grid-cols-2'>
      <div>
        <h3 className='mb-4 text-2xl font-bold text-foreground'>{t(titleKeyMap[tab])}</h3>
        <p className='mb-6 text-muted-foreground leading-relaxed'>{t(descKeyMap[tab])}</p>
