...
import type { MultiSelectRef } from '@/components/MultiSelect/type';
...
export const Route = createFileRoute('/multi-select')({
  component: Home
});
...
export default function Home() {
  ...
  const isGrayMode = false;
  const [groupedSelection, setGroupedSelection] = useState<string[]>(['react', 'nodejs']);
  const [imperativeSelection, setImperativeSelection] = useState<string[]>(['react', 'next.js']);

  const [variantDemo, setVariantDemo] = useState<string[]>(['typescript']);
  const [animatedDemo, setAnimatedDemo] = useState<string[]>(['web-app']);
  const [responsiveDemo, setResponsiveDemo] = useState<string[]>(['engineering', 'design']);
  const [styledDemo, setStyledDemo] = useState<string[]>(['web-app', 'mobile-app']);
  ...
  function onSubmit(data: z.infer<typeof FormSchema>) {
    toast(
      `Form submitted with: Frameworks: ${data.frameworks?.join(
        ', '
      )}, Tech Stack: ${data.techStack?.join(', ')}, Skills: ${data.skills?.join(
        ', '
  ...
  const getDivClasses = (originalClasses: string) => {
    if (isGrayMode) {
      ...
      const hasMtClass = originalClasses.includes('mt-8') || originalClasses.includes('mt-12');
  ...
  return (
    <main className='min-h-screen bg-background overflow-x-hidden'>
      <div className='max-w-4xl mx-auto px-2 sm:px-4 py-4 w-full min-w-0' id='main-content'>
            ...
            <div
              ...
              <div className='px-6 pb-6'>
                <p className='text-blue-700 dark:text-blue-300 mb-4 leading-relaxed'>
                  Explore comprehensive examples showcasing all MultiSelect features including form
                  integration, animations, responsive design, AI/LLM configurations, and data
                  visualization. Each example is fully interactive and demonstrates real-world use
                  cases.
                </p>
                ...
                <div className='p-3 bg-blue-100 dark:bg-blue-900/50 rounded-lg border border-blue-200 dark:border-blue-700'>
                  ...
                  <p className='text-sm text-blue-700 dark:text-blue-300 mt-1'>
                    Click the chat button in the bottom-right corner to ask questions about props,
                    styling, integration patterns, or troubleshooting. The AI assistant specializes
                    in MultiSelect usage!
                  </p>
                </div>
              </div>
            </div>
                ...
                <div className='space-y-6 text-muted-foreground leading-relaxed'>
                  <div
                    ...
                    <p className='text-sm text-muted-foreground mb-6'>
                      This form demonstrates validation, error handling, and successful submission
                      workflows:
                    </p>
                    <Form {...form}>
                          ...
                          <FormField
                            ...
                            render={({ field }) => (
                              <FormItem>
                                ...
                                <FormDescription>Additional technologies you use</FormDescription>
                                <FormMessage />
                              </FormItem>
                            )}
                          />
                          ...
                          <FormField
                            ...
                            render={({ field }) => (
                              <FormItem>
                                ...
                                <FormDescription>Departments you work with</FormDescription>
                                <FormMessage />
                              </FormItem>
                            )}
                          />
                  ...
                  <div
                    ...
                    <ul className='text-sm text-muted-foreground space-y-2'>
                      <li className='flex items-start gap-2'>
                        ...
                        <span>
                          <strong>Type Safety:</strong> Full TypeScript support with Zod schema
                          validation
                        </span>
                      </li>
                      <li className='flex items-start gap-2'>
                        <Icons.check className='h-4 w-4 text-green-500 mt-0.5 flex-shrink-0' />
                        <span>
                          <strong>Error Handling:</strong> Automatic validation messages and error
                          states
                        </span>
                      </li>
                      <li className='flex items-start gap-2'>
                        <Icons.check className='h-4 w-4 text-green-500 mt-0.5 flex-shrink-0' />
                        <span>
                          <strong>Performance:</strong> Optimized re-renders with React Hook Form
                        </span>
                      </li>
                      <li className='flex items-start gap-2'>
                        <Icons.check className='h-4 w-4 text-green-500 mt-0.5 flex-shrink-0' />
                        <span>
                          <strong>Accessibility:</strong> Built-in ARIA labels and keyboard
                          navigation
                        </span>
                      </li>
                    </ul>
                    ...
                    <div className='grid md:grid-cols-2 gap-4 text-sm'>
                      <div>
                        ...
                        <ul className='space-y-1 text-muted-foreground'>
                          <li>
                            <strong>Default:</strong> Primary forms, main content areas
                          </li>
                          <li>
                            <strong>Secondary:</strong> Sidebars, optional settings
                          </li>
                          <li>
                            <strong>Destructive:</strong> Delete actions, error handling
                          </li>
                          <li>
                            <strong>Inverted:</strong> Hero sections, dark themes
                          </li>
                        </ul>
                      </div>
                      <div>
                    ...
                    <div className='flex items-start gap-4'>
                      ...
                      <div>
                        ...
                        <p className='text-base text-muted-foreground mb-4'>
                          Use animations purposefully to enhance user experience, not distract from
                          it. Consider your application&apos;s context and user needs when choosing
                          animation styles.
                        </p>
                        <div className='grid md:grid-cols-2 gap-4 text-sm'>
                          <div>
              ...
              <div className='prose prose-lg dark:prose-invert max-w-none'>
                <div className='space-y-6 text-muted-foreground leading-relaxed'>
                  <div
                    ...
                    <p className='text-sm text-muted-foreground mb-6'>
                      Try resizing your browser window to see how the component adapts its maxCount
                      and layout behavior:
                    </p>
                    <div className='space-y-4'>
                      <MultiSelect
                      ...
                      <div className='grid grid-cols-1 md:grid-cols-3 gap-4 mt-6'>
                        ...
                        <div className='bg-white/70 dark:bg-slate-900/70 rounded-lg p-4 border border-teal-200/50 dark:border-teal-700/50'>
                          ...
                          <p className='text-xs text-muted-foreground'>maxCount: 4, Full layout</p>
                        </div>
                      </div>
                      <div
                        className={getDivClasses(
                        ...
                        <p className='text-sm font-medium text-green-800 dark:text-green-200'>
                          Current Selection: {responsiveDemo.join(', ') || 'None selected'}
                        </p>
                      </div>
                    </div>
                  </div>
                  <div
                    ...
                    <div className='flex items-start gap-4'>
                      ...
                      <div>
                        ...
                        <p className='text-base text-muted-foreground mb-4'>
                          Our responsive system follows mobile-first principles, starting with
                          optimized mobile experience and progressively enhancing for larger
                          screens. This ensures excellent performance across all devices.
                        </p>
                        <div className='text-sm text-muted-foreground'>
                          <strong className='text-foreground'>Key Benefits:</strong> Faster mobile
                          loading, better touch interactions, improved accessibility, and consistent
                    ...
                    <div className='space-y-4'>
                      ...
                      <div
                        ...
                        <p className='text-sm font-medium text-blue-800 dark:text-blue-200'>
                          Selected Stack: {groupedSelection.join(', ') || 'None selected'}
                        </p>
                      </div>
                    </div>
                  </div>
                  <div
                    ...
                    <div className='flex items-start gap-4'>
                      ...
                      <div>
                        ...
                        <p className='text-base text-muted-foreground mb-4'>
                          Groups are defined in the options data structure using separators or
                          category labels. The component automatically renders visual dividers and
                          maintains group integrity during search operations.
                        </p>
                        <div className='text-sm text-muted-foreground'>
                          <strong className='text-foreground'>Pro Tip:</strong> Use consistent
                          naming conventions for your groups and consider alphabetical ordering
                          within each category for optimal user experience.
                        </div>
                      </div>
                    </div>
                  </div>
                          ...
                          <MultiSelect
                            ...
                            emptyIndicator={
                              <div className='text-center p-4 text-muted-foreground'>
                                ...
                                <p className='text-sm'>No frameworks found matching your search</p>
                              </div>
                            }
                            animationConfig={{
                              badgeAnimation: 'bounce',
                  ...
                  <div
                    ...
                    <div className='flex items-start gap-4'>
                      ...
                      <div>
                        ...
                        <p className='text-base text-muted-foreground mb-4'>
                          Our search implementation is optimized for performance with debounced
                          input handling, efficient filtering algorithms, and smooth animations that
                          don&apos;t block user interactions.
                        </p>
                        <div className='text-sm text-muted-foreground'>
                          <strong className='text-foreground'>Best Practices:</strong> Use
                          descriptive placeholders, provide helpful empty states, and consider
                          disabling search for small option sets (≤10 items) to simplify the
                          interface.
                        </div>
                      </div>
                    </div>
                    ...
                    <div className='space-y-6'>
                      <div className='bg-white/70 dark:bg-slate-900/70 rounded-lg p-4 border border-orange-200/50 dark:border-orange-700/50'>
                        ...
                        <MultiSelect
                          ...
                          onValueChange={() => {}}
                          defaultValue={['engineering', 'design', 'product', 'marketing', 'sales']}
                          singleLine={true}
                          maxCount={8}
                      ...
                      <div className='grid gap-4 grid-cols-1 md:grid-cols-2'>
                        <div className='bg-white/70 dark:bg-slate-900/70 rounded-lg p-4 border border-amber-200/50 dark:border-amber-700/50'>
                          <div className='flex items-center gap-2 mb-3'>
                            ...
                            <span className='font-medium text-foreground text-sm'>Fixed Width</span>
                        ...
                        <div className='bg-white/70 dark:bg-slate-900/70 rounded-lg p-4 border border-yellow-200/50 dark:border-yellow-700/50'>
                          <div className='flex items-center gap-2 mb-3'>
                            ...
                            <span className='font-medium text-foreground text-sm'>Auto Width</span>
                  ...
                  <div
                    ...
                    <div className='flex items-start gap-4'>
                      ...
                      <div>
                        ...
                        <p className='text-base text-muted-foreground mb-4'>
                          Choose the right layout mode based on your design constraints. Use
                          single-line mode for toolbars and compact interfaces, auto-sizing for
                          flexible content areas, and fixed width for consistent layouts.
                        </p>
                        <div className='text-sm text-muted-foreground'>
                          <strong className='text-foreground'>Pro Tip:</strong> Combine layout
                          options with responsive configurations to create interfaces that work
                          beautifully across all screen sizes and use cases.
                        </div>
                      </div>
                    </div>
                  </div>
                        ...
                        <div
                          ...
                          <div className='space-y-2 text-sm'>
                            ...
                            <div className='flex items-center gap-2'>
                              ...
                              <span className='text-muted-foreground'>Desktop Apps</span>
                            </div>
                          </div>
                        </div>
                        <div
                  ...
                  <div
                    ...
                    <div className='flex items-start gap-4'>
                      ...
                      <div>
                        ...
                        <p className='text-base text-muted-foreground mb-4'>
                          Custom styling seamlessly integrates with your existing design system.
                          Define colors that match your brand, use consistent spacing, and maintain
                          visual hierarchy across your application.
                        </p>
                        <div className='text-sm text-muted-foreground'>
                          <strong className='text-foreground'>Pro Tip:</strong> Use semantic color
                          names and CSS custom properties to create a scalable theming system that
                          adapts to different contexts and user preferences.
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div
                    ...
                    <div className='flex items-start gap-4'>
                      ...
                      <div>
                        ...
                        <p className='text-base text-muted-foreground mb-4'>
                          Disabled states maintain excellent accessibility with proper ARIA
                          attributes, keyboard navigation support, and clear visual indicators that
                          help users understand why certain options are unavailable.
                        </p>
                        <div className='text-sm text-muted-foreground'>
                          <strong className='text-foreground'>Best Practice:</strong> Always provide
                          contextual information about why options are disabled, and consider
                          offering alternative paths when possible.
                        </div>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className='grid gap-6 grid-cols-1'>
                      ...
                      <div
                        ...
                        <div className='flex items-center gap-2 mb-3'>
                          ...
                          <span className='font-medium text-foreground text-sm'>Modal Popover</span>
                        </div>
                        <p className='text-xs text-muted-foreground mb-3'>
                  ...
                  <div
                    ...
                    <div className='flex items-start gap-4'>
                      ...
                      <div>
                        ...
                        <p className='text-base text-muted-foreground mb-4'>
                          These advanced features are designed for enterprise applications where
                          user experience consistency, accessibility compliance, and edge case
                          handling are critical requirements.
                        </p>
                        <div className='text-sm text-muted-foreground'>
                          <strong className='text-foreground'>Use Cases:</strong> Complex forms,
                          data dashboards, content management systems, and applications with
                          sophisticated user interaction patterns.
                        </div>
                      </div>
                    </div>
                  </div>
          ...
          <Card
            ...
            <div className='p-8 md:p-12'>
              <div className='mb-8 text-center'>
                ...
                <p className='text-lg text-muted-foreground max-w-2xl mx-auto leading-relaxed'>
                  Create interactive, data-driven dashboards where MultiSelect components control
                  chart filters, time periods, and visualization parameters. Perfect for business
              ...
              <div className='prose prose-lg dark:prose-invert max-w-none'>
                <div className='space-y-6 text-muted-foreground leading-relaxed'>
                  <p className='text-base md:text-lg'>
                    Choosing the right technology stack is crucial for any successful project.
                    Whether you&apos;re building a
                    <span className='font-semibold text-foreground'> web application</span>,
                    <span className='font-semibold text-foreground'> mobile app</span>, or
                    <span className='font-semibold text-foreground'> enterprise solution</span>, the
                    technologies you select will impact your development speed, scalability, and
                  ...
                  <div className='my-8 p-6 bg-white/60 dark:bg-slate-900/60 rounded-xl border border-slate-200 dark:border-slate-700 shadow-sm'>
                    <div className='mb-4'>
                      ...
                      <p className='text-sm text-muted-foreground mb-4'>
                        Try our interactive multi-select component to choose technologies for your
                        project:
                      </p>
                    </div>
                    <MultiSelect
                  ...
                  <p className='text-base md:text-lg'>
                    ...
                    <span className='font-semibold text-foreground'> TypeScript</span> for its type
                    safety,
                    <span className='font-semibold text-foreground'> React</span> for
                    component-based architecture, and{' '}
                    <span className='font-semibold text-foreground'> Node.js</span> for full-stack
                  ...
                  <p className='text-base md:text-lg'>
                    The choice of technology stack should align with your project requirements, team
                    expertise, and long-term goals. Consider factors such as
                    ...
                    <span className='font-semibold text-foreground'> maintainability</span>, and{' '}
                  ...
                  <div className='my-8'>
                    ...
                    <p className='text-base md:text-lg mb-4'>
                      Before finalizing your tech stack, assess your team&apos;s current skills and
                      expertise. This will help determine whether you need additional training or if
                      you should consider alternative technologies.
                    </p>
                    <div
                      className={getDivClasses(
                  ...
                  <p className='text-base md:text-lg'>
                    Remember, the best technology stack is the one that your team can effectively
                    use to deliver value to your users. Don&apos;t choose technologies just because
                    they&apos;re trendy – choose them because they solve real problems and fit your
                    specific use case.
                  </p>
                </div>
              </div>
                ...
                <div className='space-y-8 text-muted-foreground leading-relaxed'>
                  <div className='markdown-section'>
                    ...
                    <p className='text-base md:text-lg mb-6'>
                      Select all programming languages that you work with on a regular basis. This
                      helps us understand the current landscape of developer preferences and
                      industry trends.
                    </p>
                  ...
                  <div className='markdown-section'>
                    <h3 className='text-xl md:text-2xl font-bold text-foreground mb-4 flex items-center gap-3'>
                      ...
                      Which frameworks and libraries are you most interested in learning?
                    </h3>
                    <p className='text-base md:text-lg mb-6'>
                      The tech industry evolves rapidly. Tell us which technologies you&apos;re
                      planning to learn next year. This could include frameworks you&apos;ve heard
                      about but haven&apos;t had the chance to try yet.
                    </p>
                    <div className='bg-white/70 dark:bg-slate-900/70 rounded-xl p-6 border border-emerald-200/50 dark:border-emerald-700/50 shadow-sm'>
                      <h4 className='font-semibold text-foreground mb-3 flex items-center gap-2'>
                  ...
                  <div className='markdown-section'>
                    ...
                    <p className='text-base md:text-lg mb-6'>
                      Understanding the types of projects developers work on helps us identify
                      common patterns and challenges. Whether you&apos;re building{' '}
                  ...
                  <div className='markdown-section'>
                    ...
                    <p className='text-base md:text-lg mb-6'>
                      Everyone has different learning styles. Some prefer hands-on coding, others
                      like structured courses. Understanding how developers learn helps the
                  ...
                  <div
                    ...
                    <p className='text-base text-muted-foreground mb-4'>
                      Your responses help us understand the developer community better. This survey
                      demonstrates how MultiSelect components can be seamlessly integrated into
                      forms and surveys.
                    </p>
          ...
          <Card
            ...
            <div className='p-8 md:p-12'>
              <div className='mb-8 text-center'>
                ...
                <p className='text-lg text-muted-foreground max-w-2xl mx-auto leading-relaxed'>
                  Complete documentation of all MultiSelect component properties, with examples,
                  defaults, and best practices for every configuration option.
                </p>
              </div>
                  ...
                  <Card className='p-6 bg-white/80 dark:bg-gray-900/80 border-rose-200 dark:border-rose-800'>
                    ...
                    <div className='space-y-3 text-sm'>
                      ...
                      <div
                        ...
                        <p className='text-muted-foreground mt-1'>
                          Placeholder text (default: &ldquo;Select options&rdquo;)
                        </p>
                      </div>
                    </div>
                  </Card>
                  ...
                  <Card className='p-6 bg-white/80 dark:bg-gray-900/80 border-rose-200 dark:border-rose-800'>
                    ...
                    <div className='grid gap-3 md:grid-cols-2 text-sm'>
                      ...
                      <div
                        ...
                        <p className='text-muted-foreground mt-1'>Custom animation settings</p>
                      </div>
                      <div
                        className={getDivClasses(
                          'p-3 bg-red-50 dark:bg-red-900/20 rounded border-l-4 border-red-300'
                      ...
                      <div
                        ...
                        <code className='font-semibold'>deduplicateOptions</code>
                        <p className='text-muted-foreground mt-1'>
              ...
              <div className='p-0 pt-6'>
                <div
                  ...
                  <p className='text-rose-800 dark:text-rose-200 font-medium flex items-start gap-2'>
                    ...
                    <span>
                      <strong>Quick Start:</strong> Most use cases only need options, onValueChange,
                      and optionally defaultValue. All other props enhance the experience but have
                      sensible defaults.
                    </span>
                  </p>
                </div>
